...
import ClaimBusiness from "./screens/directory/claimBusiness/claim";
...
function App() {
  const appRoutes = [
    ...
    { path: routes.page.ClaimedBusiness, element: <ClaimBusiness /> },
  ...
  const authRoutes = [
    ...
    { path: routes.auth.passwordResetSuccessful, element: <PasswordResetPassword /> },
